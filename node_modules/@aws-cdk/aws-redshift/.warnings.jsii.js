    ...
    try {
        ...
        if (p.roles != null)
            for (const o of p.roles)
                if (!visitedObjects.has(o))
                    require("@aws-cdk/aws-iam/.warnings.jsii.js")._aws_cdk_aws_iam_IRole(o);
        if (p.securityGroups != null)
            for (const o of p.securityGroups)
                if (!visitedObjects.has(o))
                    require("@aws-cdk/aws-ec2/.warnings.jsii.js")._aws_cdk_aws_ec2_ISecurityGroup(o);
    ...
    try {
        if (p.tableColumns != null)
            for (const o of p.tableColumns)
                if (!visitedObjects.has(o))
                    _aws_cdk_aws_redshift_Column(o);
...
function _aws_cdk_aws_redshift_CfnEndpointAccess_NetworkInterfaceProperty(p) {
}
function _aws_cdk_aws_redshift_CfnEndpointAccess_VpcEndpointProperty(p) {
}
...
function _aws_cdk_aws_redshift_CfnScheduledAction_PauseClusterMessageProperty(p) {
}
function _aws_cdk_aws_redshift_CfnScheduledAction_ResizeClusterMessageProperty(p) {
}
function _aws_cdk_aws_redshift_CfnScheduledAction_ResumeClusterMessageProperty(p) {
}
function _aws_cdk_aws_redshift_CfnScheduledAction_ScheduledActionTypeProperty(p) {
}
